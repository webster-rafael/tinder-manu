    ...
    for (let s = 1; s < arguments.length; s += 1) {
        ...
        if (null != i && !S(i)) {
            ...
            for (let t = 0, r = s.length; t < r; t += 1) {
                ...
                void 0 !== n && n.enumerable && (w(e[r]) && w(i[r]) ? i[r].__swiper__ ? e[r] = i[r] : T(e[r], i[r]) : !w(e[r]) && w(i[r]) ? (e[r] = {}, i[r].__swiper__ ? e[r] = i[r] : T(e[r], i[r])) : e[r] = i[r])
            }
        }
    }
    return e
...
function A(e) {
    return void 0 === e && (e = {}), k || (k = function(e) {
        ...
        const p = n.match(/(iPod)(.*OS\s([\d_]+))?/),
            ...
            h = "Win32" === r;
        let m = "MacIntel" === r;
        return !c && m && s.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(`${o}x${l}`) >= 0 && (c = n.match(/(Version)\/([\d.]+)/), c || (c = [0, 1, "13_0_0"]), m = !1), d && !h && (a.os = "android", a.android = !0), (c || u || p) && (a.os = "ios", a.ios = !0), a
    }(e)), k
}
    ...
    V = e => {
        ...
        if (e.params.rewind || e.params.loop)
            for (let a = r - t; a <= n + t; a += 1) {
                ...
                for (let a = Math.max(r - t, 0); a <= Math.min(n + t, s - 1); a += 1) a !== r && (a > n || a < r) && _(e, a)
    };
...
function B(e) {
    ...
    Object.assign(r, {
        ...
        isScrolling: void 0,
        startMoving: void 0
    }), a.startX = m, a.startY = g, r.touchStartTime = v(), t.allowClick = !0, t.updateSize(), t.swipeDirection = void 0, n.threshold > 0 && (r.allowThresholdMove = !1);
    let w = !0;
...
function $(e) {
    ...
    s.swipeDirection = m > 0 ? "prev" : "next", s.touchesDirection = g > 0 ? "prev" : "next";
    ...
    if ((new Date).getTime(), i.isMoved && i.allowThresholdMove && w !== s.touchesDirection && S && T && Math.abs(m) >= 1) return Object.assign(n, {
        startX: c,
        startY: p,
        currentX: c,
        currentY: p,
    ...
    let b = !0,
        x = r.resistanceRatio;
    if (r.touchReleaseOnEdges && (x = 0), m > 0 ? (S && T && i.allowThresholdMove && i.currentTranslate > (r.centeredSlides ? s.minTranslate() - s.slidesSizesGrid[s.activeIndex + 1] : s.minTranslate()) && s.loopFix({
            direction: "prev",
            setTranslate: !0,
            activeSlideIndex: 0
        }), i.currentTranslate > s.minTranslate() && (b = !1, r.resistance && (i.currentTranslate = s.minTranslate() - 1 + (-s.minTranslate() + i.startTranslate + m) ** x))) : m < 0 && (S && T && i.allowThresholdMove && i.currentTranslate < (r.centeredSlides ? s.maxTranslate() + s.slidesSizesGrid[s.slidesSizesGrid.length - 1] : s.maxTranslate()) && s.loopFix({
            direction: "next",
            setTranslate: !0,
...
function j(e) {
    ...
    for (let m = 0; m < l.length; m += m < n.slidesPerGroupSkip ? 1 : n.slidesPerGroup) {
        ...
        void 0 !== l[m + e] ? u >= l[m] && u < l[m + e] && (h = m, f = l[m + e] - l[m]) : u >= l[m] && (h = m, f = l[l.length - 1] - l[l.length - 2])
    }
    let g = null,
        w = null;
    ...
    if (p > n.longSwipesMs) {
        ...
        "next" === t.swipeDirection && (S >= n.longSwipesRatio ? t.slideTo(n.rewind && t.isEnd ? g : h + T) : t.slideTo(h)), "prev" === t.swipeDirection && (S > 1 - n.longSwipesRatio ? t.slideTo(h + T) : null !== w && S < 0 && Math.abs(S) > n.longSwipesRatio ? t.slideTo(w) : t.slideTo(h))
    } else {
        if (!n.shortSwipes) return void t.slideTo(t.activeIndex);
        t.navigation && (r.target === t.navigation.nextEl || r.target === t.navigation.prevEl) ? r.target === t.navigation.nextEl ? t.slideTo(h + T) : t.slideTo(h) : ("next" === t.swipeDirection && t.slideTo(null !== g ? g : h + T), "prev" === t.swipeDirection && t.slideTo(null !== w ? w : h))
    }
}
...
const q = (e, t) => {
    ...
    s[l]("touchstart", e.onDocumentTouchStart, {
        ...
        passive: !0
    }), (i.preventClicks || i.preventClicksPropagation) && r[l]("click", e.onClick, !0), i.cssMode && n[l]("scroll", e.onScroll), i.updateOnWindowResize ? e[d](a.ios || a.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", H, !0) : e[d]("observerUpdate", H, !0), r[l]("load", e.onLoad, {
        capture: !0
    })
};
...
const Q = {
        ...
        update: {
            updateSize: function() {
                ...
                let t, s;
                const i = e.el;
                t = void 0 !== e.params.width && null !== e.params.width ? e.params.width : i.clientWidth, s = void 0 !== e.params.height && null !== e.params.height ? e.params.height : i.clientHeight, 0 === t && e.isHorizontal() || 0 === s && e.isVertical() || (t = t - parseInt(P(i, "padding-left") || 0, 10) - parseInt(P(i, "padding-right") || 0, 10), s = s - parseInt(P(i, "padding-top") || 0, 10) - parseInt(P(i, "padding-bottom") || 0, 10), Number.isNaN(t) && (t = 0), Number.isNaN(s) && (s = 0), Object.assign(e, {
                    width: t,
                    height: s,
            ...
            updateSlides: function() {
                ...
                for (let b = 0; b < p; b += 1) {
                    let i;
                    if (C = 0, c[b] && (i = c[b]), M && e.grid.updateSlide(b, i, c), !c[b] || "none" !== P(i, "display")) {
                        if ("auto" === s.slidesPerView) {
                            L && (c[b].style[e.getDirectionLabel("width")] = "");
                            const r = getComputedStyle(i),
                                n = i.style.transform,
                                a = i.style.webkitTransform;
                            if (n && (i.style.transform = "none"), a && (i.style.webkitTransform = "none"), s.roundLengths) C = e.isHorizontal() ? I(i, "width", !0) : I(i, "height", !0);
                            else {
                                const e = t(r, "width"),
                                    s = t(r, "padding-left"),
                                    n = t(r, "padding-right"),
                        ...
                        } else C = (n - (s.slidesPerView - 1) * S) / s.slidesPerView, s.roundLengths && (C = Math.floor(C)), c[b] && (c[b].style[e.getDirectionLabel("width")] = `${C}px`);
                        c[b] && (c[b].swiperSlideSize = C), f.push(C), s.centeredSlides ? (T = T + C / 2 + x / 2 + S, 0 === x && 0 !== b && (T = T - n / 2 - S), 0 === b && (T = T - n / 2 - S), Math.abs(T) < .001 && (T = 0), s.roundLengths && (T = Math.floor(T)), E % s.slidesPerGroup == 0 && u.push(T), h.push(T)) : (s.roundLengths && (T = Math.floor(T)), (E - Math.min(e.params.slidesPerGroupSkip, E)) % e.params.slidesPerGroup == 0 && u.push(T), h.push(T), T = T + C + S), e.virtualSize += C + S, x = C, E += 1
                    }
                }
                if (e.virtualSize = Math.max(e.virtualSize, n) + v, a && o && ("slide" === s.effect || "coverflow" === s.effect) && (i.style.width = `${e.virtualSize+S}px`), s.setWrapperSize && (i.style[e.getDirectionLabel("width")] = `${e.virtualSize+S}px`), M && e.grid.updateWrapperSize(C, u), !s.centeredSlides) {
                    const t = [];
                ...
                if (Object.assign(e, {
                    ...
                    b(i, "--swiper-centered-offset-before", -u[0] + "px"), b(i, "--swiper-centered-offset-after", e.size / 2 - f[f.length - 1] / 2 + "px");
                    const t = -e.snapGrid[0],
                        s = -e.slidesGrid[0];
                    e.snapGrid = e.snapGrid.map((e => e + t)), e.slidesGrid = e.slidesGrid.map((e => e + s))
                }
                if (p !== d && e.emit("slidesLengthChange"), u.length !== g && (e.params.watchOverflow && e.checkOverflow(), e.emit("snapGridLengthChange")), h.length !== w && e.emit("slidesGridLengthChange"), s.watchSlidesProgress && e.updateSlidesOffset(), !(l || s.cssMode || "slide" !== s.effect && "fade" !== s.effect)) {
            ...
            updateSlidesProgress: function(e) {
                ...
                for (let l = 0; l < i.length; l += 1) {
                    ...
                    (u >= 0 && u < t.size - 1 || h > 1 && h <= t.size || u <= 0 && h >= t.size) && (t.visibleSlides.push(e), t.visibleSlidesIndexes.push(l), i[l].classList.add(s.slideVisibleClass)), f && i[l].classList.add(s.slideFullyVisibleClass), e.progress = r ? -c : c, e.originalProgress = r ? -p : p
                }
            },
        ...
        slide: {
            slideTo: function(e, t, s, i, r) {
                ...
                let w;
                if (a !== (c || 0) && s && n.emit("beforeSlideChangeStart"), n.updateProgress(g), w = a > p ? "next" : a < p ? "prev" : "reset", u && -g === n.translate || !u && g === n.translate) return n.updateActiveIndex(a), o.autoHeight && n.updateAutoHeight(), n.updateSlidesClasses(), "slide" !== o.effect && n.setTranslate(g), "reset" !== w && (n.transitionStart(s, w), n.transitionEnd(s, w)), !1;
                if (o.cssMode) {
                    const e = n.isHorizontal(),
                        s = u ? g : -g;
                    if (0 === t) {
            ...
            slideToClickedSlide: function() {
                ...
                if (t.loop) {
                    ...
                    r = parseInt(e.clickedSlide.getAttribute("data-swiper-slide-index"), 10), t.centeredSlides ? n < e.loopedSlides - i / 2 || n > e.slides.length - e.loopedSlides + i / 2 ? (e.loopFix(), n = e.getSlideIndex(y(s, `${a}[data-swiper-slide-index="${r}"]`)[0]), m((() => {
                        e.slideTo(n)
                    }))) : e.slideTo(n) : n > e.slides.length - i ? (e.loopFix(), n = e.getSlideIndex(y(s, `${a}[data-swiper-slide-index="${r}"]`)[0]), m((() => {
                        e.slideTo(n)
                    }))) : e.slideTo(n)
                } else e.slideTo(n)
            }
        ...
        loop: {
            loopCreate: function(e) {
                ...
                if (o) {
                    ...
                    } else E("Swiper Loop Warning: The number of slides is not even to slidesPerGroup, loop mode may not function properly. You need to add more slides (or make duplicates, or empty slides)");
                    r()
                } else if (l) {
                    if (s.loopAddBlankSlides) {
                        d(s.grid.rows - t.slides.length % s.grid.rows), t.recalcSlides(), t.updateSlides()
                    } else E("Swiper Loop Warning: The number of slides is not even to grid.rows, loop mode may not function properly. You need to add more slides (or make duplicates, or empty slides)");
                    r()
                } else r();
                t.loopFix({
                    slideRealIndex: e,
            ...
            loopFix: function(e) {
                ...
                if (c.allowSlidePrev = !0, c.allowSlideNext = !0, c.virtual && m.virtual.enabled) return s && (m.centeredSlides || 0 !== c.snapIndex ? m.centeredSlides && c.snapIndex < m.slidesPerView ? c.slideTo(c.virtual.slides.length + c.snapIndex, 0, !1, !0) : c.snapIndex === c.snapGrid.length - 1 && c.slideTo(c.virtual.slidesBefore, 0, !1, !0) : c.slideTo(c.virtual.slides.length, 0, !1, !0)), c.allowSlidePrev = u, c.allowSlideNext = h, void c.emit("loopFix");
                let g = m.slidesPerView;
                "auto" === g ? g = c.slidesPerViewDynamic() : (g = Math.ceil(parseFloat(m.slidesPerView, 10)), v && g % 2 == 0 && (g += 1));
                const w = m.slidesPerGroupAuto ? g : m.slidesPerGroup;
                let S = w;
                S % w != 0 && (S += w - S % w), S += m.loopAdditionalSlides, c.loopedSlides = S;
                ...
                const L = T ? Math.ceil(p.length / m.grid.rows) : p.length,
                    k = (T ? p[n].column : n) + (v && void 0 === r ? -g / 2 + .5 : 0);
                if (k < S) {
                    C = Math.max(S - k, w);
                    for (let e = 0; e < S - k; e += 1) {
                        ...
                        if (T) {
                            const e = L - t - 1;
                            for (let t = p.length - 1; t >= 0; t -= 1) p[t].column === e && b.push(t)
                        } else b.push(L - t - 1)
                    }
                } else if (k + g > L - S) {
                ...
                if (P && b.forEach((e => {
                    ...
                    })), c.recalcSlides(), "auto" === m.slidesPerView ? c.updateSlides() : T && (b.length > 0 && P || x.length > 0 && M) && c.slides.forEach(((e, t) => {
                    ...
                    if (b.length > 0 && P) {
                        if (void 0 === t) {
                            ...
                            d ? c.setTranslate(c.translate - t) : (c.slideTo(y + C, 0, !1, !0), r && (c.touchEventsData.startTranslate = c.touchEventsData.startTranslate - t, c.touchEventsData.currentTranslate = c.touchEventsData.currentTranslate - t))
                        } else if (r) {
                    ...
                    if (void 0 === t) {
                        ...
                        d ? c.setTranslate(c.translate - t) : (c.slideTo(y - I, 0, !1, !0), r && (c.touchEventsData.startTranslate = c.touchEventsData.startTranslate - t, c.touchEventsData.currentTranslate = c.touchEventsData.currentTranslate - t))
                    } else {
                        const e = T ? x.length / m.grid.rows : x.length;
                        c.slideTo(c.activeIndex - e, 0, !1, !0)
                    }
                if (c.allowSlidePrev = u, c.allowSlideNext = h, c.controller && c.controller.control && !a) {
                    const e = {
                        slideRealIndex: t,
                        direction: i,
                        setTranslate: r,
        ...
        events: {
            attachEvents: function() {
                ...
                e.onTouchStart = B.bind(e), e.onTouchMove = $.bind(e), e.onTouchEnd = j.bind(e), e.onDocumentTouchStart = X.bind(e), t.cssMode && (e.onScroll = W.bind(e)), e.onClick = R.bind(e), e.onLoad = Y.bind(e), q(e, "on")
            },
        ...
        breakpoints: {
            setBreakpoint: function() {
                ...
                }), c && !f ? e.disable() : !c && f && e.enable(), e.currentBreakpoint = a, e.emit("_beforeBreakpoint", o), s && (u ? (e.loopDestroy(), e.loopCreate(t), e.updateSlides()) : !h && m ? (e.loopCreate(t), e.updateSlides()) : h && !m && e.loopDestroy()), e.emit("breakpoint", o)
            },
...
class ee {
    constructor() {
        ...
        1 === i.length && i[0].constructor && "Object" === Object.prototype.toString.call(i[0]).slice(8, -1) ? t = i[0] : [e, t] = i, t || (t = {}), t = T({}, t), e && !t.el && (t.el = e);
        const n = u();
        ...
        const a = this;
        a.__swiper__ = !0, a.support = z(), a.device = A({
        ...
        const l = T({}, U, o);
        return a.params = T({}, l, Z, t), a.originalParams = T({}, a.params), a.passedParams = T({}, t), a.params && a.params.on && Object.keys(a.params.on).forEach((e => {
    ...
    getSlideIndex(e) {
        const {
            slidesEl: t,
            params: s
        } = this, i = C(y(t, `.${s.slideClass}, swiper-slide`)[0]);
        return C(e) - i
    }
    ...
    mount(e) {
        ...
        return !r && t.params.createElements && (r = M("div", t.params.wrapperClass), s.append(r), y(s, `.${t.params.slideClass}`).forEach((e => {
            r.append(e)
        }))), Object.assign(t, {
            el: s,
            wrapperEl: r,
